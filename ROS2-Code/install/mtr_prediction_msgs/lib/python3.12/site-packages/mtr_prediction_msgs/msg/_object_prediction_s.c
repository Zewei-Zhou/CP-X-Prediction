...
bool mtr_prediction_msgs__msg__predicted_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool mtr_prediction_msgs__msg__object_prediction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mtr_prediction_msgs.msg._object_prediction.ObjectPrediction", full_classname_dest, 59) == 0);
  }
  mtr_prediction_msgs__msg__ObjectPrediction * ros_message = _ros_message;
  {  // object_id
  ...
  {  // trajectories
    ...
    if (!mtr_prediction_msgs__msg__PredictedTrajectory__Sequence__init(&(ros_message->trajectories), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mtr_prediction_msgs__msg__PredictedTrajectory__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mtr_prediction_msgs__msg__PredictedTrajectory * dest = ros_message->trajectories.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mtr_prediction_msgs__msg__predicted_trajectory__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * mtr_prediction_msgs__msg__object_prediction__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mtr_prediction_msgs.msg._object_prediction");
  ...
  {  // trajectories
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mtr_prediction_msgs__msg__predicted_trajectory__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
