...
bool mtr_prediction_msgs__msg__object_state_prediction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mtr_prediction_msgs.msg._object_state_prediction.ObjectStatePrediction", full_classname_dest, 70) == 0);
  }
  mtr_prediction_msgs__msg__ObjectStatePrediction * ros_message = _ros_message;
  {  // probability
  ...
  {  // states
    ...
    mtr_prediction_msgs__msg__ObjectState * dest = ros_message->states.data;
...
{
  /* NOTE(esteve): Call constructor of ObjectStatePrediction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mtr_prediction_msgs.msg._object_state_prediction");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectStatePrediction");
