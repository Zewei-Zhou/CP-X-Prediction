...
class Metaclass_ObjectStatePrediction(type):
    """Metaclass of message 'ObjectStatePrediction'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__object_state_prediction
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__object_state_prediction
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__object_state_prediction
            cls._TYPE_SUPPORT = module.type_support_msg__msg__object_state_prediction
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__object_state_prediction
...
class ObjectStatePrediction(metaclass=Metaclass_ObjectStatePrediction):
    """Message class 'ObjectStatePrediction'."""
    ...
    _fields_and_field_types = {
        'probability': 'double',
        'states': 'sequence<mtr_prediction_msgs/ObjectState>',
    }
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'states' field must be a set or sequence and each value of type 'ObjectState'"
        self._states = value
