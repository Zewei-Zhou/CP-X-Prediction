...
static const _ObjectClassification_type_support_symbol_names_t _ObjectClassification_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mtr_prediction_msgs, msg, ObjectClassification)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mtr_prediction_msgs, msg, ObjectClassification)),
  }
};
...
{
  return &::mtr_prediction_msgs::msg::rosidl_typesupport_cpp::ObjectClassification_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mtr_prediction_msgs, msg, ObjectClassification)() {
  return get_message_type_support_handle<mtr_prediction_msgs::msg::ObjectClassification>();
}
