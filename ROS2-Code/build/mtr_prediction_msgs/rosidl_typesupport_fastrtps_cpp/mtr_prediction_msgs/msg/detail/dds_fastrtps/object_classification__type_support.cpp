...
#include "mtr_prediction_msgs/msg/detail/object_classification__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mtr_prediction_msgs::msg::ObjectClassification & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mtr_prediction_msgs::msg::ObjectClassification & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mtr_prediction_msgs::msg::ObjectClassification;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mtr_prediction_msgs::msg::ObjectClassification *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mtr_prediction_msgs::msg::ObjectClassification *>(
    untyped_ros_message);
...
{
  return &mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::_ObjectClassification__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mtr_prediction_msgs, msg, ObjectClassification)() {
  return &mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::_ObjectClassification__handle;
}
