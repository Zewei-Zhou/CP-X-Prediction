...
#include "mtr_prediction_msgs/msg/detail/object_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mtr_prediction_msgs::msg::ObjectClassification &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const mtr_prediction_msgs::msg::ObjectReferencePoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const mtr_prediction_msgs::msg::ObjectState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.continuous_state;
  }
  // Member: discrete_state
  {
    cdr << ros_message.discrete_state;
  }
  // Member: continuous_state_covariance
  {
    cdr << ros_message.continuous_state_covariance;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mtr_prediction_msgs::msg::ObjectState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: sensor_id
  {
    ...
    size_t item_size = sizeof(ros_message.sensor_id[0]);
  ...
  // Member: continuous_state
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.continuous_state[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: discrete_state
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.discrete_state[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: continuous_state_covariance
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.continuous_state_covariance[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: classifications
  ...
  size_t current_alignment)
{
  ...
  // Member: classifications
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjectClassification(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: reference_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjectReferencePoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mtr_prediction_msgs::msg::ObjectState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mtr_prediction_msgs::msg::ObjectState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mtr_prediction_msgs::msg::ObjectState *>(
    untyped_ros_message);
...
{
  return &mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::_ObjectState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mtr_prediction_msgs, msg, ObjectState)() {
  return &mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::_ObjectState__handle;
}
