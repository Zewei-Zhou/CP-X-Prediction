...
#include "mtr_prediction_msgs/msg/detail/predicted_trajectories__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mtr_prediction_msgs::msg::ObjectPrediction &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mtr_prediction_msgs::msg::ObjectPrediction &);
size_t get_serialized_size(
  const mtr_prediction_msgs::msg::ObjectPrediction &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const mtr_prediction_msgs::msg::PredictedTrajectories & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mtr_prediction_msgs::msg::PredictedTrajectories & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mtr_prediction_msgs
max_serialized_size_PredictedTrajectories(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: predictions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjectPrediction(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mtr_prediction_msgs::msg::PredictedTrajectories;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mtr_prediction_msgs::msg::PredictedTrajectories *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mtr_prediction_msgs::msg::PredictedTrajectories *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PredictedTrajectories__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mtr_prediction_msgs::msg::PredictedTrajectories *>(
...
static size_t _PredictedTrajectories__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PredictedTrajectories(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PredictedTrajectories__callbacks = {
...
static rosidl_message_type_support_t _PredictedTrajectories__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PredictedTrajectories__callbacks,
...
{
  return &mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::_PredictedTrajectories__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mtr_prediction_msgs, msg, PredictedTrajectories)() {
  return &mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::_PredictedTrajectories__handle;
}
