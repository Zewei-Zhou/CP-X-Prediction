...
#include "mtr_prediction_msgs/msg/detail/tracked_object_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mtr_prediction_msgs::msg::TrackedObject &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const mtr_prediction_msgs::msg::TrackedObjectArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mtr_prediction_msgs::msg::TrackedObjectArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrackedObject(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mtr_prediction_msgs::msg::TrackedObjectArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mtr_prediction_msgs::msg::TrackedObjectArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mtr_prediction_msgs::msg::TrackedObjectArray *>(
    untyped_ros_message);
...
{
  return &mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::_TrackedObjectArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mtr_prediction_msgs, msg, TrackedObjectArray)() {
  return &mtr_prediction_msgs::msg::typesupport_fastrtps_cpp::_TrackedObjectArray__handle;
}
