    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mtr_prediction_msgs.msg.ObjectList')
            logger.debug(
            ...
            from mtr_prediction_msgs.msg import Object
...
class ObjectList(metaclass=Metaclass_ObjectList):
    ...
    _fields_and_field_types = {
        ...
        'objects': 'sequence<mtr_prediction_msgs/Object>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mtr_prediction_msgs', 'msg'], 'Object')),  # noqa: E501
    )
