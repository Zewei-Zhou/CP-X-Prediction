...
#include "mtr_prediction_msgs/msg/detail/tracked_object__rosidl_typesupport_fastrtps_c.h"
...
#include "mtr_prediction_msgs/msg/detail/object_state__functions.h"  // track_history
...
using _TrackedObject__ros_msg_type = mtr_prediction_msgs__msg__TrackedObject;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: track_history
  {
    ...
    auto array_ptr = ros_message->track_history.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: track_history
  {
    ...
    if (ros_message->track_history.data) {
      mtr_prediction_msgs__msg__ObjectState__Sequence__fini(&ros_message->track_history);
    }
    if (!mtr_prediction_msgs__msg__ObjectState__Sequence__init(&ros_message->track_history, size)) {
      fprintf(stderr, "failed to create array for field 'track_history'");
      return false;
    }
    auto array_ptr = ros_message->track_history.data;
    for (size_t i = 0; i < size; ++i) {
...
static uint32_t _TrackedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mtr_prediction_msgs__msg__TrackedObject(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mtr_prediction_msgs__msg__TrackedObject;
    is_plain =
      (
...
static size_t _TrackedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mtr_prediction_msgs__msg__TrackedObject(
