...
#include "mtr_prediction_msgs/msg/detail/object_reference_point__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // translation_to_geometric_center
...
using _ObjectReferencePoint__ros_msg_type = mtr_prediction_msgs__msg__ObjectReferencePoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectReferencePoint__ros_msg_type * ros_message = static_cast<const _ObjectReferencePoint__ros_msg_type *>(untyped_ros_message);
  // Field name: value
  {
    cdr << ros_message->value;
  }

  // Field name: translation_to_geometric_center
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->translation_to_geometric_center, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _ObjectReferencePoint__ros_msg_type * ros_message = static_cast<_ObjectReferencePoint__ros_msg_type *>(untyped_ros_message);
  // Field name: value
  {
    cdr >> ros_message->value;
  }
...
static uint32_t _ObjectReferencePoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mtr_prediction_msgs__msg__ObjectReferencePoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mtr_prediction_msgs__msg__ObjectReferencePoint;
    is_plain =
      (
...
static size_t _ObjectReferencePoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mtr_prediction_msgs__msg__ObjectReferencePoint(
...
static message_type_support_callbacks_t __callbacks_ObjectReferencePoint = {
...
static rosidl_message_type_support_t _ObjectReferencePoint__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObjectReferencePoint,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mtr_prediction_msgs, msg, ObjectReferencePoint)() {
  return &_ObjectReferencePoint__type_support;
}
