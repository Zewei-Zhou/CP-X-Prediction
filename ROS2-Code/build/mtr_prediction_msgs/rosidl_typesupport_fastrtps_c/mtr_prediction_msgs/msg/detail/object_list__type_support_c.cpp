...
#include "mtr_prediction_msgs/msg/detail/object_list__rosidl_typesupport_fastrtps_c.h"
...
#include "mtr_prediction_msgs/msg/detail/object__functions.h"  // objects
...
using _ObjectList__ros_msg_type = mtr_prediction_msgs__msg__ObjectList;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: objects
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mtr_prediction_msgs, msg, Object
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: objects
  {
    ...
    if (ros_message->objects.data) {
      mtr_prediction_msgs__msg__Object__Sequence__fini(&ros_message->objects);
    }
    if (!mtr_prediction_msgs__msg__Object__Sequence__init(&ros_message->objects, size)) {
...
size_t get_serialized_size_mtr_prediction_msgs__msg__ObjectList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectList__ros_msg_type * ros_message = static_cast<const _ObjectList__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mtr_prediction_msgs__msg__Object(
...
static uint32_t _ObjectList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mtr_prediction_msgs__msg__ObjectList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mtr_prediction_msgs
size_t max_serialized_size_mtr_prediction_msgs__msg__ObjectList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mtr_prediction_msgs__msg__Object(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mtr_prediction_msgs__msg__ObjectList;
    is_plain =
      (
...
static size_t _ObjectList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mtr_prediction_msgs__msg__ObjectList(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mtr_prediction_msgs, msg, ObjectList)() {
