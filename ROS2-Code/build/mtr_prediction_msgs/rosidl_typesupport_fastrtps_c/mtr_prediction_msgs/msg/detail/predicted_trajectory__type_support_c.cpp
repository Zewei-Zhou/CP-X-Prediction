...
#include "mtr_prediction_msgs/msg/detail/predicted_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/twist_stamped__functions.h"  // velocities
...
using _PredictedTrajectory__ros_msg_type = mtr_prediction_msgs__msg__PredictedTrajectory;

static bool _PredictedTrajectory__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PredictedTrajectory__ros_msg_type * ros_message = static_cast<const _PredictedTrajectory__ros_msg_type *>(untyped_ros_message);
...
static bool _PredictedTrajectory__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _PredictedTrajectory__ros_msg_type * ros_message = static_cast<_PredictedTrajectory__ros_msg_type *>(untyped_ros_message);
  // Field name: confidence
  {
    cdr >> ros_message->confidence;
  }
  ...
  // Field name: velocities
  {
    ...
    if (ros_message->velocities.data) {
      geometry_msgs__msg__TwistStamped__Sequence__fini(&ros_message->velocities);
    }
    if (!geometry_msgs__msg__TwistStamped__Sequence__init(&ros_message->velocities, size)) {
...
static uint32_t _PredictedTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mtr_prediction_msgs__msg__PredictedTrajectory(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mtr_prediction_msgs__msg__PredictedTrajectory;
    is_plain =
      (
...
static size_t _PredictedTrajectory__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_mtr_prediction_msgs__msg__PredictedTrajectory(
...
static message_type_support_callbacks_t __callbacks_PredictedTrajectory = {
  "mtr_prediction_msgs::msg",
  "PredictedTrajectory",
  _PredictedTrajectory__cdr_serialize,
  _PredictedTrajectory__cdr_deserialize,
  _PredictedTrajectory__get_serialized_size,
  _PredictedTrajectory__max_serialized_size
};

static rosidl_message_type_support_t _PredictedTrajectory__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PredictedTrajectory,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mtr_prediction_msgs, msg, PredictedTrajectory)() {
  return &_PredictedTrajectory__type_support;
}
