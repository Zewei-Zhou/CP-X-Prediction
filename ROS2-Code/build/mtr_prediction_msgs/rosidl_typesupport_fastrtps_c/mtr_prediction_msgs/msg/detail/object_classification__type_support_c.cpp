...
#include "mtr_prediction_msgs/msg/detail/object_classification__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectClassification__ros_msg_type = mtr_prediction_msgs__msg__ObjectClassification;
...
static uint32_t _ObjectClassification__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mtr_prediction_msgs__msg__ObjectClassification(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mtr_prediction_msgs__msg__ObjectClassification;
    is_plain =
      (
...
static size_t _ObjectClassification__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mtr_prediction_msgs__msg__ObjectClassification(
