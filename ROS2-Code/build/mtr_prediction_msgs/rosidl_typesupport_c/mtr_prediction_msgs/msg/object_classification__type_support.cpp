...
static const _ObjectClassification_type_support_symbol_names_t _ObjectClassification_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mtr_prediction_msgs, msg, ObjectClassification)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mtr_prediction_msgs, msg, ObjectClassification)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mtr_prediction_msgs, msg, ObjectClassification)() {
  return &::mtr_prediction_msgs::msg::rosidl_typesupport_c::ObjectClassification_message_type_support_handle;
}
