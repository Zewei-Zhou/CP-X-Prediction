...
static const _TrackedObjectArray_type_support_symbol_names_t _TrackedObjectArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mtr_prediction_msgs, msg, TrackedObjectArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mtr_prediction_msgs, msg, TrackedObjectArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mtr_prediction_msgs, msg, TrackedObjectArray)() {
  return &::mtr_prediction_msgs::msg::rosidl_typesupport_c::TrackedObjectArray_message_type_support_handle;
}
