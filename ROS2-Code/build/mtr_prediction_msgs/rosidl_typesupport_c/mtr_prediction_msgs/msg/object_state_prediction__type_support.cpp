...
static const _ObjectStatePrediction_type_support_symbol_names_t _ObjectStatePrediction_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mtr_prediction_msgs, msg, ObjectStatePrediction)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mtr_prediction_msgs, msg, ObjectStatePrediction)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mtr_prediction_msgs, msg, ObjectStatePrediction)() {
  return &::mtr_prediction_msgs::msg::rosidl_typesupport_c::ObjectStatePrediction_message_type_support_handle;
}
