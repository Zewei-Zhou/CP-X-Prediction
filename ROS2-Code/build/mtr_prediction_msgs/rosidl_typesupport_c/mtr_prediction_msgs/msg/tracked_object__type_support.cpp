...
static const _TrackedObject_type_support_symbol_names_t _TrackedObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mtr_prediction_msgs, msg, TrackedObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mtr_prediction_msgs, msg, TrackedObject)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mtr_prediction_msgs, msg, TrackedObject)() {
  return &::mtr_prediction_msgs::msg::rosidl_typesupport_c::TrackedObject_message_type_support_handle;
}
