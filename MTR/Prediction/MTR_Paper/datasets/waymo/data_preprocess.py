...
def decode_map_features_from_proto(map_features):
    ...
    for cur_data in map_features:
        ...
        if cur_data.lane.ByteSize() > 0:
            ...
            # Skip unknown map feature types
            print(f"Warning: Unknown map feature type for feature {cur_data.id}, skipping...")
            print(cur_data)
            continue  # Skip this feature and don't add to polylines
        # else:
        #     print(cur_data)
        #     raise ValueError
