...
from train_utils import WaymoDataset, load_config, collate_waymo_batch
...
def train(cfg_file, percent_data):
    ...
    # create dataset
    train_dataset = WaymoDataset(cfg, 'train', percent_data)
    print("Train Dataset:", len(train_dataset))
    val_dataset = WaymoDataset(cfg, 'test', 1.0)
    ...
    train_loader = DataLoader(
        ...
        shuffle=True,
        collate_fn=collate_waymo_batch
    )
...
if __name__ == '__main__':
    ...
    train(args.cfg, args.data_percent)
